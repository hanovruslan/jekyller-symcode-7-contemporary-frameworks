...
**Монолитный - не универсальный**{:.slide-red.next}

**Микро - не имеет определенного предназначения**{:.slide-red.next}

**Web - не микро**{:.slide-red.next}

**No framework - не универсальный**{:.slide-red.next}
...
**php-конфиги**{:.slide-red.next}

**большой список прямых зависимостей**{:.slide-red.next}
...
## Результат исследования (про Symfony4) ##
