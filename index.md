...
**Zend framework**
- Первый релиз - Март 2006 (+6 месяцев)
- 1.12.20 (последний в 1.x) - Сентябрь 2016
- 2.0 - Сентябрь 2012 (+1 год)
- 2.5.3 (последний в 2.x) январь 2016

<!-- right -->

**Symfony**
- Первый релиз - октябрь 2005
- 1.5.11 (последний в 1.x) - Март 2018 (+1.5 года)
- 2.0 - Июль 2011
- 2.8.51 (последний в 2.x) - Апрель 2019 (!) (+3 года)
...
**Инструментарий**
**Среда**
Предназначение - Web, RAD, CLI
Тип - Скорее "No framework"
