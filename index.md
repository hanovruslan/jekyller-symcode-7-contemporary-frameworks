...
**Первый релиз - Март 2006 (+6 месяцев)**{:.next}
- {:.next}Первый релиз - октябрь 2005
**1.12.20 (последний в 1.x) - Сентябрь 2016**{:.next}
- {:.next}1.5.11 (последний в 1.x) - Март 2018 (+1.5 года)
**2.0 - Сентябрь 2012 (+1 год)**{:.next}
- {:.next}2.0 - Июль 2011
**2.5.3 (последний в 2.x) январь 2016**{:.next}
